...
RUN yum install -y R firefox  xrdp tigervnc-server zsh libevent ibus-kkc file bind-utils vcftools bedtools supervisor libxml2 mock gcc rpm-build rpm-devel rpmlint make python bash coreutils diffutils patch rpmdevtools
